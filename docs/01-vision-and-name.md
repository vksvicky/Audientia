...
- Device sync (USB, MTP, SMB, Wi-Fi), transcoding, and playlists
- Streaming (local + remote) via Subsonic-compatible APIs
- Smart features (ML-assisted tagging, duplicate detection, recommendations)
- First-class testing culture (TDD/BDD/ATDD) and rock-solid reliability
