//
//  AudioVisualiserViewBDDTests.swift
//  UITests
//
//  BDD tests for AudioVisualiserView
//
...
/// BDD tests for AudioVisualiserView
@MainActor
final class AudioVisualiserViewBDDTests: XCTestCase {
    ...
    /// BDD: Given a playing track, when I view the visualiser, then it should display real-time spectrum data
    ...
    /// BDD: Given a paused track, when I view the visualiser, then it should maintain the last frame
    func testPausedTrackMaintainsLastFrame() {
        ...
        // Then - View should maintain visualisation
        XCTAssertNotNil(view)
    }
    
    /// BDD: Given different frequency content, when I view the visualiser, then colors should reflect frequency bands
