//
//  AudioVisualizerModesBDDTests.swift
//  UITests
//
//  BDD tests for AudioVisualizerModes visualization algorithms
//  Tests user scenarios for each visualization mode based on audioMotion-analyzer
//
...
/// BDD tests for AudioVisualizerModes
/// Tests user scenarios for visualization modes
@MainActor
final class AudioVisualizerModesBDDTests: XCTestCase {
    ...
    func testDiscreteFrequenciesShowsIndividualBins() {
        // Given - A visualizer view with discrete frequencies mode
    ...
    func testDiscreteFrequenciesHasCorrectSpacing() {
        ...
        let normalizedMagnitudes = normalizer.normalize(testFrame.magnitudes)
    ...
    /// BDD: As a user, when I view any visualization mode,
