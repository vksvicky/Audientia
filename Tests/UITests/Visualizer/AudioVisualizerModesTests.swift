//
//  AudioVisualizerModesTests.swift
//  UITests
//
//  TDD tests for AudioVisualizerModes visualization algorithms
//  Tests the audioMotion-analyzer-based algorithms for each visualization mode
//
...
// Import SpectrumNormalizer for testing
extension AudioCore.SpectrumNormalizer {}
...
/// TDD tests for AudioVisualizerModes
/// Tests the visualization algorithms based on audioMotion-analyzer
@MainActor
final class AudioVisualizerModesTests: XCTestCase {
    private var testFrame: AudioVisualizerFrame!
    ...
    override func setUpWithError() throws {
        ...
        testFrame = AudioVisualizerFrame(
    ...
    func testProcessMagnitudesReturnsNormalizedRange() {
        ...
        let view = AudioVisualizerView(nowPlayingViewModel: nil)
    ...
    private func processMagnitudesHelper(view: AudioVisualizerView, frame: AudioVisualizerFrame) -> ProcessMagnitudesResult {
        ...
        // For now, we'll test the SpectrumNormalizer directly
    ...
    private func colorForFrequencyHelper(view: AudioVisualizerView, ratio: CGFloat, energy: CGFloat) -> Color {
    ...
    func testProcessMagnitudesWithEmptyFrame() {
        ...
        let emptyFrame = AudioVisualizerFrame(
            magnitudes: [],
            timestamp: Date(),
            sampleRate: 44100,
            fftSize: 1024
    ...
    func testProcessMagnitudesWithAllZeros() {
        ...
        let zeroFrame = AudioVisualizerFrame(
    ...
    func testProcessMagnitudesInverseRelationship() {
        ...
        let lowFrame = AudioVisualizerFrame(
        ...
        let highFrame = AudioVisualizerFrame(
    ...
    func testProcessMagnitudesWithInvalidData() {
        ...
        let invalidFrame = AudioVisualizerFrame(
            magnitudes: magnitudes,
            timestamp: Date(),
            sampleRate: 44100,
            fftSize: 1024
    ...
    func testProcessMagnitudesPerformance() {
        ...
        let largeFrame = AudioVisualizerFrame(
