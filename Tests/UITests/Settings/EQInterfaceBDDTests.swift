...
final class EQInterfaceBDDTests: XCTestCase {
    ...
    /// BDD: As a user, I want to access the equalizer interface so that I can adjust audio frequencies
    func testUserAccessesEqualizerInterface() {
        // Given - I want to adjust audio frequencies
        // When - I open the equalizer interface
    ...
    func testUserSees10BandEQControls() {
        // Given - I have the equalizer interface open
        let view = EQInterfaceView()
    ...
    func testUserCanEnableDisableEqualizer() {
        // Given - I have the equalizer interface open
        let view = EQInterfaceView()
    ...
    func testUserCanResetEqualizer() {
        // Given - I have the equalizer interface open
        let view = EQInterfaceView()
    ...
    func testViewRendersWithoutErrors() {
        // Given - I have the equalizer interface view
        let view = EQInterfaceView()
