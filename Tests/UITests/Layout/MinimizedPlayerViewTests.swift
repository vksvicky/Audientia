//
//  MinimizedPlayerViewTests.swift
//  UITests
//
//  TDD tests for MinimizedPlayerView following Right-BICEP principles
//
...
@MainActor
final class MinimizedPlayerViewTests: XCTestCase {
    ...
    func testViewInitialization() {
        ...
        // When: Creating MinimizedPlayerView
