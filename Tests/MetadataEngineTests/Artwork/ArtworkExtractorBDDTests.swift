...
/// BDD tests for ArtworkExtractor
...
final class ArtworkExtractorBDDTests: XCTestCase {
    ...
    /// Scenario: As a user, I want to extract artwork from my MP3 files
    func testExtractArtworkFromMP3File() async throws {
    ...
    /// Scenario: As a user, I want to see that files without artwork return nil gracefully
    func testExtractArtworkFromFileWithoutArtwork() async throws {
        ...
        XCTAssertNil(artwork, "Should return nil for file without artwork")
    }
    
    /// Scenario: As a user, I want to extract artwork from various audio formats
    func testExtractArtworkFromVariousFormats() async throws {
        // Given - Files in different formats (MP3, M4A, FLAC)
        // Note: Requires test fixtures
        throw XCTSkip("Requires test fixtures with artwork in various formats")
        
        // When - Extract artwork from each format
        // Then - Should extract artwork successfully
    }
    
    /// Scenario: As a user, I want to handle errors gracefully when artwork extraction fails
    func testHandleArtworkExtractionErrors() async {
