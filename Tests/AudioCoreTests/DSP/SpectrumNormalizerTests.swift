//
//  SpectrumNormalizerTests.swift
//  AudioCoreTests
//
//  TDD tests for SpectrumNormalizer
//
...
/// TDD tests for SpectrumNormalizer
final class SpectrumNormalizerTests: XCTestCase {
    private var normalizer: SpectrumNormalizer!
    ...
    func testNormalizeEmptyMagnitudesReturnsEmpty() {
        ...
        // When
        let result = normalizer.normalize(magnitudes)
    ...
    func testNormalizeZerosOutOfRangeFrequencies() {
        // Given - Create a normalizer with restricted frequency range
        let restrictedNormalizer = SpectrumNormalizer(
            logScale: 2.0,
            minFreq: 100.0,
            maxFreq: 1000.0,
            sampleRate: 44100,
    ...
    func testCompressAdjustsDynamicRange() {
        ...
        let compressed = normalizer.compress(magnitudes, sensitivity: 2.0)
    ...
    func testFrequencyForBinMatchesCalculation() {
        ...
        // When
        let frequency = normalizer.frequencyForBin(binIndex)
    ...
    func testBinForFrequencyMatchesCalculation() {
        ...
        // When
        let bin = normalizer.binForFrequency(frequency)
    ...
    func testBinForFrequencyOutOfRangeReturnsNegative() {
        ...
        // When
        let bin = normalizer.binForFrequency(lowFreq)
