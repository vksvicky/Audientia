...
/// BDD scenarios for the audio visualiser feed
final class AudioVisualiserBDDTests: XCTestCase {
    ...
    /// BDD: Given a bass-heavy track, when I view the visualiser, then low-frequency bands should dominate
    func testBassHeavyTrackShowsLowFrequencyEnergy() async throws {
        ...
        // When - I process the visualiser frame
    ...
    func testRecentFramesOrderedAndCapped() async throws {
        ...
        let recentFrames = await visualiser.recentFrames(limit: 10)
