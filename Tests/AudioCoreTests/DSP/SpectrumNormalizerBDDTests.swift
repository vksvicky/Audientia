//
//  SpectrumNormalizerBDDTests.swift
//  AudioCoreTests
//
//  BDD tests for SpectrumNormalizer
//
...
/// BDD tests for SpectrumNormalizer
final class SpectrumNormalizerBDDTests: XCTestCase {
    ...
    /// BDD: Given a bass-heavy audio spectrum, when I normalize it, then low frequencies should be emphasized for visualization
    ...
    func testCompressSuppressesQuietSections() {
        ...
        let compressed = normalizer.compress(magnitudes, sensitivity: 1.5)
    ...
    func testNormalizedSpectrumMatchesHumanPerception() {
        ...
        let normalized = normalizer.normalize(linearMagnitudes)
