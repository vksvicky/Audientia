...
/// Configuration for the audio visualiser feed
...
/// FFT frame produced by the audio visualiser feed
public struct AudioVisualiserFrame: Equatable, Sendable {
...
/// Errors that can occur during visualiser processing
public enum AudioVisualiserError: Error, Equatable {
    case invalidFFTSize
...
/// Audio visualiser protocol for producing FFT magnitude data for the UI
public protocol AudioVisualiserProtocol: Sendable {
    /// Process audio data and return a visualiser frame
