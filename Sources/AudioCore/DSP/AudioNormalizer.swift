...
public final class AudioNormalizer: AudioNormalizationProtocol, @unchecked Sendable {
    ...
    public func analyzeNormalization(
        ...
        guard sampleRate > 0 else {
            throw AudioNormalizationError.invalidSampleRate
        }
        guard channels > 0 else {
            throw AudioNormalizationError.invalidChannelCount
        }
        guard !audioData.isEmpty else {
            throw AudioNormalizationError.invalidAudioData
        }
    ...
    public func calculateLoudness(
        ...
        guard sampleCount > 0 else {
            throw AudioNormalizationError.analysisFailed("No valid samples found")
        }
