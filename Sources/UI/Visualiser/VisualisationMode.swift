//
//  VisualisationMode.swift
//  Audientia
//
//  Visualization mode enum for audio visualiser
//
...
public enum VisualisationMode: String, CaseIterable, Identifiable {
    ...
    /// Asset catalog image name for the visualisation mode icon
