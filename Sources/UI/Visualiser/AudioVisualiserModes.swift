//
//  AudioVisualiserModes.swift
//  Audientia
//
//  Visualization mode implementations for AudioVisualiserView
...
extension AudioVisualiserView {
    ...
    func discreteFrequenciesView(frame: AudioVisualiserFrame, geometry: GeometryProxy) -> some View {
    ...
    func radialSpectrumView(frame: AudioVisualiserFrame, geometry: GeometryProxy) -> some View {
    ...
    /// Create a dashed arc path for radial spectrum visualisation
    ...
    /// Dual Channel Combined Graph - Combined left/right channel visualisation
    ...
    func dualChannelGraphView(frame: AudioVisualiserFrame, geometry: GeometryProxy) -> some View {
        let processedData = processMagnitudes(frame: frame)
    ...
    func ledBarsView(frame: AudioVisualiserFrame, geometry: GeometryProxy) -> some View {
    ...
    func lumiBarsView(frame: AudioVisualiserFrame, geometry: GeometryProxy) -> some View {
        let processedData = processMagnitudes(frame: frame)
        let numBars = processedData.normalized.count
    ...
    func roundBarsReflexView(frame: AudioVisualiserFrame, geometry: GeometryProxy) -> some View {
        let processedData = processMagnitudes(frame: frame)
        let numBars = processedData.normalized.count
    ...
    /// Converts raw FFT magnitudes to normalized values for visualisation
    internal func processMagnitudes(frame: AudioVisualiserFrame) -> (normalized: [CGFloat], colors: [Color]) {
