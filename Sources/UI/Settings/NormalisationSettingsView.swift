//
//  NormalisationSettingsView.swift
//  Audientia
//
...
@MainActor
public struct NormalisationSettingsView: View {
    @StateObject private var viewModel = NormalisationSettingsViewModel()
...
@MainActor
private final class NormalisationSettingsViewModel: ObservableObject {
    @Published var mode: NormalizationMode = .peak
    @Published var targetLevel: Float = -3.0
    
    private let normaliser = AudioNormaliser()
