...
# Build Apple Silicon App With Libraries Included
# FFmpeg libraries are bundled in the app
#
# Usage:
#   ./build_silicon_with_libs.sh [--dmg]
#
# Options:
...
echo "🔨 Building Apple Silicon App (With Libraries Included)"
echo "========================================================="
echo ""
...
FFMPEG_LIBS_DIR="$PROJECT_ROOT/ThirdParty/FFmpeg/arm64"
...
OUTPUT_DIR="$BUILD_DIR/Silicon-WithLibs"
mkdir -p "$OUTPUT_DIR"
...
if [ "$CREATE_DMG" = true ]; then
    ...
    DMG_NAME="${APP_NAME}-Silicon-WithLibs"
