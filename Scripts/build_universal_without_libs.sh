...
# Build Universal App Without Libraries
# Users must install FFmpeg and chromaprint separately
#
# Usage:
#   ./build_universal_without_libs.sh [--dmg]
#
# Options:
...
echo "🔨 Building Universal App (Without Libraries)"
echo "=============================================="
echo ""
...
OUTPUT_DIR="$BUILD_DIR/Universal-WithoutLibs"
mkdir -p "$OUTPUT_DIR"
...
if [ "$CREATE_DMG" = true ]; then
    ...
    DMG_NAME="${APP_NAME}-Universal-WithoutLibs"
